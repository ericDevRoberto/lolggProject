package com.lolgg.api

import com.lolgg.model.api.response.GetRankedInfoResponse
import com.lolgg.model.api.response.GetSummonerInfoResponse
...
interface RiotApiService {
    ...
    suspend fun getMacheInfo(@Path("continetal_server") continentalServer: String, @Path("match_id") matchId: String ): Flow<List<String>>
}